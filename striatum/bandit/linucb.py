...
class LinUCB(BaseBandit):
    ...
    def __init__(self,
                 ...
                 recommendation_cls=None,   # recommendation class
                 context_dimension=128,     # the dimension of the context
                 alpha=0.5):
        ...
        model = {
            # dictionary - For any action a in actions, A[a] = (DaT*Da + I) the ridge reg solution
            'A': {},
            # dictionary - The inverse of each A[a] for action a in actions
            'A_inv': {},
            # dictionary - The cumulative return of action a, given the context xt.
            'b': {},
            # dictionary - The coefficient vector of action a with linear model b = dot(xt, theta)
            'theta': {},
        }
