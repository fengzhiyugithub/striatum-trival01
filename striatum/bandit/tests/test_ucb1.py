...
class TestUCB1(ChangeableActionSetBanditTest, BaseBanditTest,
               unittest.TestCase):
    ...
    def test_model_storage(self):
        ...
        self.assertEqual(
            model['total_action_reward'][recommendations[0].action.id], 2.)
        self.assertEqual(model['action_times'][recommendations[0].action.id],
                         2)
    ...
    def test_add_action(self):
        ...
        history_id2, recommendations = policy.get_action(
            context=None, n_actions=4)
